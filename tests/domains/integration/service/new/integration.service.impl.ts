...
describe('new integration service tests', () => {
  ...
  it('should create a pending project authorization successfully', async () => {
    ...
    expect(emailServiceMock.sendAuthorizationMail).toHaveBeenNthCalledWith(1, '1' + mockedAdminEmail, { integratorName: mockedMemberName, projectName: mockedProjectName, projectId: mockedProviderProjectId, url: mockedUrl, token: expect.any(String) });
    expect(emailServiceMock.sendAuthorizationMail).toHaveBeenNthCalledWith(2, '2' + mockedAdminEmail, { integratorName: mockedMemberName, projectName: mockedProjectName, projectId: mockedProviderProjectId, url: mockedUrl, token: expect.any(String) });
